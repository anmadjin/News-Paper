...
from .views import PostsList, PostDetail, PostsSearch, NewsCreate, NewsUpdate, NewsDelete, PaperCreate, PaperUpdate, PaperDelete, CategoryPostsView, subscribe, unsubscribe
